...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      to_store: options.to_store ? JSON.parse(options.to_store) : ''
    });
  },
    ...
    app.sendRequest({
      ...
      success: function (res) {
        ...
        _this.setData({
          ...
          original_price: info.original_price || '免费',
  ...
  payOrder: function (orderId) {
    ...
    function paySuccess() {
      var pagePath = '/eCommerce/pages/goodsOrderPaySuccess/goodsOrderPaySuccess?detail=' + orderId + (that.franchisee_id ? '&franchisee=' + that.franchisee_id : '') + '&is_group=' + !!that.is_group + '&code=code';
    ...
    function payFail() {
      app.turnToPage('/eCommerce/pages/appointmentOrderDetail/appointmentOrderDetail?detail=' + orderId, 1);
    }
  ...
  goToMyAddress: function () {
    ...
    app.turnToPage('/eCommerce/pages/myAddress/myAddress?id=' + addressId + '&need_address=' + this.data.need_user_address);
  },
  ...
  getSuppInfo: function (suppInfoArr) {
    ...
    app.sendRequest({
      hideLoading: true,
      url: '/index.php?r=AppShop/GetDelivery',
      method: 'post',
      data: {
        delivery_id: suppInfoArr[0]
      },
      success: function (res) {
        if (res.data) {

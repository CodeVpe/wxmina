...
Page({
  ...
  onShareAppMessage: function(){
    let that = this,
        ...
        url = '/pages/toStoreDetail/toStoreDetail?detail=' + goodsId + (franchiseeId ? '&franchisee=' + franchiseeId : '') + urlPromotion + (app.globalData.pageShareKey ? ('&pageShareKey=' + app.globalData.pageShareKey) : '');
